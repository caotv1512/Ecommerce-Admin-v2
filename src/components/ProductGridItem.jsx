                    ...
                    !isSlide && (
                        <>
                            <p className="font-heading font-bold text-sm leading-[1.4]">
                                Giá gốc : ${product.regular_price || 0}
                            </p>
                            <p className="font-heading font-bold text-sm leading-[1.4]">
                                Giá bán : ${product.sale_price || 0}
                            </p>
                        </>
                    )
                }
                ...
                !isSlide && (
                    <div className="grid grid-cols-2 gap-1.5 mt-4">
                        <NavLink className="btn btn--outline blue !text-sm" to="/product-editor">
                            <i className="icon icon-pen-solid text-xs"/> Sửa
                        </NavLink>
                        <button className="btn btn--outline red !text-sm">Xóa</button>
                    </div>
                )
            }
        </Wrapper>
